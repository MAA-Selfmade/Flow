...
class Component extends DCLogic {
  ...
  setOngoing(id, on) {
    ...
    this.flash(on ? '“' + t.title + '” er flyttet til Løbende arbejde på Min dag.' : '“' + t.title + '” er tilbage blandt opgaverne.');
  }
  ...
  renderVals() {
    ...
    const pool0 = s0.tasks.filter(t => !this.hiddenFor(t) && (s0.view === 'tid' || (!this.archived(t) && !t.ongoing)) && (!s0.projFilter || t.project === s0.projFilter)
    ...
    const v = {
      ...
      projectNav: s0.projects.map(p => ({ name: p.name, color: p.color,
        open: s0.tasks.filter(t => t.project === p.id && t.status !== 'faerdig' && !t.ongoing && !this.hiddenFor(t)).length,
