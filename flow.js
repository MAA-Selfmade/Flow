...
class Component extends DCLogic {
  ...
  saveDraft() {
    ...
    if (d.editId) {
      ...
      if (d.startTimer) this.toggleTimer(id);
  ...
  renderVals() {
    ...
    if (s.sel && this.T(s.sel)) {
      ...
      v.d = Object.assign({}, c, {
        ...
        logBtnBorder: (s0.logForm || {}).task === t.id ? '#0031EB' : '#DFDBD3', logBtnBg: (s0.logForm || {}).task === t.id ? '#F0F4FE' : '#fff', logBtnColor: (s0.logForm || {}).task === t.id ? '#0031EB' : '#4A443F',
    ...
    if (dr) {
      ...
      v.m = {
        ...
        onStartTimer: () => this.dset({ startTimer: !dr.startTimer }), startTimerIcon: dr.startTimer ? '■' : '▶',
        startTimerTitle: dr.startTimer ? 'Timeren starter, når opgaven oprettes. Klik for at fortryde.' : 'Start timer, når opgaven oprettes',
        startTimerBorder: dr.startTimer ? '#0031EB' : '#DFDBD3', startTimerBg: dr.startTimer ? '#0031EB' : '#fff', startTimerColor: dr.startTimer ? '#fff' : '#6E675F',
        startTimerText: dr.startTimer ? 'Starter ved oprettelse' : 'Start timer', startTimerTextColor: dr.startTimer ? '#0031EB' : '#4A443F',
